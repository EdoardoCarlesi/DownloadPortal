...
def create_pdf_from_csv(csv_file, output_pdf):
    ...
    print(f"[{datetime.now()}] PDF report successfully created: {output_pdf}")


def generate_weekly_report():
    # Specify the input CSV and output PDF paths
    input_csv = "xxyears/static/codes_used.csv"
    output_pdf = "weekly_codes_used_report.pdf"
...
if __name__ == "__main__":
    # Schedule the report generation every week
    print("Scheduling weekly PDF report generation...")
    schedule.every().week.do(generate_weekly_report)
